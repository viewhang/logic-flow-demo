 ...
 * 并行流程节点
 */
export default function registerConcurrency(lf, clickAddSub, mouseDownAddSub) {
    lf.register('concurrency', ({ RectNode, RectNodeModel, h }) => {
        class ConcurrencyNode extends RectNode {
            //并行流程标题
            getNameLabelShape() {
        ...
        class ConcurrencyModel extends RectNodeModel {
